...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Mohamad Albie 2019</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- jquery UI -->
<script src="<?= base_url('lib/') ?>jquery-ui.js"></script>

<!-- Custom scripts for all pages-->
<script src="<?= base_url('lib/') ?>js/sb-admin-2.min.js"></script>
<!-- Sweetjs -->
<script src="<?= base_url('lib/') ?>js/sweetalert2.min.js"></script>

<!-- Angular.js -->
<script src="<?= base_url('lib/') ?>angular.min.js"></script>

<!-- Custom js -->
<script src="<?= base_url('lib/') ?>asset.js"></script>
